...
let generate_code (x,_) index stmt =
  ...
  let attrs =
    ...
    | Insert (_, t, `Nat)  -> ["kind", "insert"; "target", t; "cardinality", "n"]
    | Insert (_, t, `Zero_one)  -> ["kind", "insert"; "target", t; "cardinality", "0"]
    | Insert (_, t, `One)  -> ["kind", "insert"; "target", t; "cardinality", "1"]
